...
- **Global scope**: `/Users/ruiwang/Developments/webank/aidx/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/ruiwang/Developments/webank/aidx/.claude/notes/`)
...
2. Glob `/Users/ruiwang/Developments/webank/aidx/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/ruiwang/Developments/webank/aidx/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/ruiwang/Developments/webank/aidx/.claude/notes/` — works in any directory
