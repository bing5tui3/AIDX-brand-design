...
```
Task(
  prompt="Read /Users/ruidemacbookair/Development/AIDX-brand-design/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/ruidemacbookair/Development/AIDX-brand-design/.claude/get-shit-done/templates/SECURITY.md`
