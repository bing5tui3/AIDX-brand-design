...
<reference>
@/Users/ruiwang/Developments/webank/aidx/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/Users/ruiwang/Developments/webank/aidx/.claude/get-shit-done/references/user-profiling.md` to load:
