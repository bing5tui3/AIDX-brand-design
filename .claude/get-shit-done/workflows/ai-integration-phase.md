...
```markdown
Read /Users/ruidemacbookair/Development/AIDX-brand-design/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/Users/ruidemacbookair/Development/AIDX-brand-design/.claude/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /Users/ruidemacbookair/Development/AIDX-brand-design/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /Users/ruidemacbookair/Development/AIDX-brand-design/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /Users/ruidemacbookair/Development/AIDX-brand-design/.claude/agents/gsd-eval-planner.md for instructions.
