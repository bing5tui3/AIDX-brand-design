...
```bash
INIT=$(node "/Users/ruidemacbookair/Development/AIDX-brand-design/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/ruidemacbookair/Development/AIDX-brand-design/.claude/get-shit-done/templates/spec.md.
