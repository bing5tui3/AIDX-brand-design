...
@/Users/ruidemacbookair/Development/AIDX-brand-design/.claude/get-shit-done/references/thinking-models-research.md
...
```bash
node "/Users/ruidemacbookair/Development/AIDX-brand-design/.claude/get-shit-done/bin/gsd-tools.cjs" graphify query "<capability-keyword>" --budget 1500
```
