...
- **Global scope**: `/Users/ruidemacbookair/Development/AIDX-brand-design/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/ruidemacbookair/Development/AIDX-brand-design/.claude/notes/`)
...
2. Glob `/Users/ruidemacbookair/Development/AIDX-brand-design/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/ruidemacbookair/Development/AIDX-brand-design/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/ruidemacbookair/Development/AIDX-brand-design/.claude/notes/` — works in any directory
