...
<required_reading>
@/Users/ruiwang/Developments/webank/aidx/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /Users/ruiwang/Developments/webank/aidx/.claude
                  → checks /Users/ruiwang/Developments/webank/aidx/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Users/ruiwang/Developments/webank/aidx/.claude/get-shit-done
                  → writes to /Users/ruiwang/Developments/webank/aidx/.claude/get-shit-done/hooks/
...
@/Users/ruiwang/Developments/webank/aidx/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @/Users/ruiwang/Developments/webank/aidx/.claude/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "/Users/ruiwang/Developments/webank/aidx/.claude/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/Users/ruiwang/Developments/webank/aidx/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/Users/ruiwang/Developments/webank/aidx/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
