...
```bash
AUDITOR_MODEL=$(node "/Users/ruiwang/Developments/webank/aidx/.claude/get-shit-done/bin/gsd-tools.cjs" resolve-model gsd-eval-auditor --raw)
```
...
```markdown
Read /Users/ruiwang/Developments/webank/aidx/.claude/agents/gsd-eval-auditor.md for instructions.
