...
```bash
node "/Users/ruidemacbookair/Development/AIDX-brand-design/.claude/get-shit-done/bin/gsd-tools.cjs" audit-open 2>/dev/null
```
...
**If doesn't exist:** Create from template at `/Users/ruidemacbookair/Development/AIDX-brand-design/.claude/get-shit-done/templates/retrospective.md`.
