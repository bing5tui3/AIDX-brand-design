...
Use template from `/Users/ruiwang/Developments/webank/aidx/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/Users/ruiwang/Developments/webank/aidx/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/Users/ruiwang/Developments/webank/aidx/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
