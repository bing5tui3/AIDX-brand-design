...
<template>
@/Users/ruidemacbookair/Development/AIDX-brand-design/.claude/get-shit-done/templates/UAT.md
</template>
...
Read and follow `/Users/ruidemacbookair/Development/AIDX-brand-design/.claude/get-shit-done/workflows/transition.md`.
...
```bash
node "/Users/ruidemacbookair/Development/AIDX-brand-design/.claude/get-shit-done/bin/gsd-tools.cjs" audit-open --json 2>/dev/null
```
...
- Follow @/Users/ruidemacbookair/Development/AIDX-brand-design/.claude/get-shit-done/workflows/diagnose-issues.md
