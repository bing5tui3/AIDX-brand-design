...
Key references:
- @/Users/ruidemacbookair/Development/AIDX-brand-design/.claude/get-shit-done/references/ui-brand.md (display patterns)
- @/Users/ruidemacbookair/Development/AIDX-brand-design/.claude/get-shit-done/agents/gsd-user-profiler.md (profiler agent definition)
- @/Users/ruidemacbookair/Development/AIDX-brand-design/.claude/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="/Users/ruidemacbookair/Development/AIDX-brand-design/.claude/get-shit-done/USER-PROFILE.md"
...
```bash
cp "/Users/ruidemacbookair/Development/AIDX-brand-design/.claude/get-shit-done/USER-PROFILE.md" "/Users/ruidemacbookair/Development/AIDX-brand-design/.claude/USER-PROFILE.backup.md"
```
...
✓ Stores profile at /Users/ruidemacbookair/Development/AIDX-brand-design/.claude/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `/Users/ruidemacbookair/Development/AIDX-brand-design/.claude/get-shit-done/references/user-profiling.md`
...
Reference: @/Users/ruidemacbookair/Development/AIDX-brand-design/.claude/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to /Users/ruidemacbookair/Development/AIDX-brand-design/.claude/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global CLAUDE.md" -- "Add profile to /Users/ruidemacbookair/Development/AIDX-brand-design/.claude/CLAUDE.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /Users/ruidemacbookair/Development/AIDX-brand-design/.claude/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at /Users/ruidemacbookair/Development/AIDX-brand-design/.claude/commands/gsd/dev-preferences.md"
...
Display: "✓ Added profile section to /Users/ruidemacbookair/Development/AIDX-brand-design/.claude/CLAUDE.md"
...
```bash
BACKUP_PATH="/Users/ruidemacbookair/Development/AIDX-brand-design/.claude/USER-PROFILE.backup.md"
```
...
Your profile:    /Users/ruidemacbookair/Development/AIDX-brand-design/.claude/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   /Users/ruidemacbookair/Development/AIDX-brand-design/.claude/commands/gsd/dev-preferences.md
  ✓ CLAUDE.md section       ./CLAUDE.md
  ✓ Global CLAUDE.md        /Users/ruidemacbookair/Development/AIDX-brand-design/.claude/CLAUDE.md
```
